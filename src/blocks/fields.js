...
Blockly.Blocks['formfield'] = {
  init: function() {
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldDropdown([["string","string"], ["number","number"], ["integer","integer"], ["boolean","boolean"], ["array","array"]]), "type");
    this.appendDummyInput()
        .appendField("Widget:")
        .appendField(new Blockly.FieldDropdown([["option","OPTIONNAME"], ["option","OPTIONNAME"], ["option","OPTIONNAME"]]), "widget");
    this.appendDummyInput()
    ...
    this.appendStatementInput("validation")
        .setCheck(["length_validation", "numeric_value_validation", "regex_validation"])
...
Blockly.Blocks['length_validation'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldDropdown([["Min Length","minLength"], ["Max Length","maxLength"]]), "type");
...
Blockly.Blocks['numeric_value_validation'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldDropdown([["Min Value","minimum"], ["Max Value","maximum"]]), "type");
...
Blockly.Blocks['help'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("Help:")
        .appendField(new Blockly.FieldDropdown([["Title","title"], ["Description","description"], ["Icon","icon"], ["Prefilled","prefilled"]]), "type");
    this.appendValueInput("value")
        .setCheck("String")
        .appendField("Value:")
...
Blockly.JavaScript['formfield'] = function(block) {
  ...
  var statements_validation = Blockly.JavaScript.statementToCode(block, 'validation');
  ...
  var code = 'fields["'+text_name+'"] = function () {\n' +
      'var element = '+JSON.stringify(json)+';\n'+
      statements_help + '\n' +
      statements_enums +'\n' +
      statements_validation +'\n' +
      'if("'+dropdown_type+'" === "array" && element["oneOf"]){\n' +
...
Blockly.JavaScript['formsection'] = function(block) {
  ...
  var code = '' +
      ...
      '};'+ '\n' +
      statements_help + '\n' +
      'return JSON.stringify({ type: "object", "properties": { "'+text_name+'": element}});\n'+
      '}());\n';
...
Blockly.JavaScript['length_validation'] = function(block) {
  ...
  var code = '' +
      'element["'+dropdown_type+'"] = '+length+';\n'+
      'if("'+text_error_message+'" != "" ) {element["x-options"]["messages"]["'+dropdown_type+'"] = "'+text_error_message+'";}\n' +
      '';
  return code;
};
...
Blockly.JavaScript['regex_validation'] = function(block) {
  ...
  var code = '' +
      ...
      'if("'+text_error_message+'" != "" ) {element["x-options"]["messages"]["pattern"] = "'+text_error_message+'";}\n' +
      '';
  return code;
};
...
Blockly.JavaScript['enum'] = function(block) {
  ...
  // TODO: Assemble JavaScript into code variable.
  var code = 'if(!element["oneOf"]) {\n' +
      'element["oneOf"] = [];\n' +
      '}\n' +
      'element["oneOf"].push({"const": "'+text_value+'", "title": "'+text_display+'"});\n';
  return code;
};
